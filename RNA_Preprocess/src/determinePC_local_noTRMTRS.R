#' filename : determinePC_local.R
#' Date : 2020-07-06
#' contributor : Yanshuo Chu
#' function: determinePC_local
...
gene.pattern <- c("^TR", "^tr", "^MT", "^mt", "^RP", "^rp")
...
seuratObj <- RunPCA(object = seuratObj, features = hvg, npcs=50, verbose = FALSE)

##generate PCA loadings plot
pdf(paste0(opt$out, ".elbowplot.pdf"))
ElbowPlot(object = seuratObj, ndims = 50, reduction = 'pca')
dev.off()
